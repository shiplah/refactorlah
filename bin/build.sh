...
DEFAULT_TARGETS="darwin/arm64 linux/arm64 windows/amd64"
RUN_TESTS=1
TARGET_MODE=host
TARGETS=
PRINT_SUMMARY=1
...
BUILD_LDFLAGS="-X refactorlah/internal/buildinfo.Version=$BUILD_VERSION"
BUILD_LDFLAGS="$BUILD_LDFLAGS -X refactorlah/internal/buildinfo.Commit=$BUILD_COMMIT"
BUILD_LDFLAGS="$BUILD_LDFLAGS -X refactorlah/internal/buildinfo.BuildDate=$BUILD_DATE"
BUILD_LDFLAGS="$BUILD_LDFLAGS -X refactorlah/internal/buildinfo.Distribution=$BUILD_DISTRIBUTION"
