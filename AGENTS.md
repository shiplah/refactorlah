...
- The current shipped native language support is PHP, Python, and deterministic Go package-move rewriting. Keep shared behaviour aligned where the language concepts match.
